...
mix.js('resources/assets/js/app.js', 'public/js')
    ...
    .js('resources/assets/js/toolbar_language_account.js', 'public/js')
    .js('resources/assets/js/toolbar_language_map.js', 'public/js')
    .js('resources/assets/js/toolbar_language_trips.js', 'public/js')
    .js('resources/assets/js/toolbar_language_show.js', 'public/js')
    ...
    .js('resources/assets/js/guest_trip_storage.js', 'public/js')
    ...
    .sass('resources/assets/scss/account.scss', 'public/css')
    .sass('resources/assets/scss/map.scss', 'public/css')
    .sass('resources/assets/scss/trips.scss', 'public/css')
    .sass('resources/assets/scss/show.scss', 'public/css')
.sourceMaps();
