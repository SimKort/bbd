...
class RatingFilterTest extends DuskTestCase
{
    use DatabaseMigrations;

    /**
     * TS-23: Siūlomų vietų filtravimas pagal atsiliepimų kiekį (pvz., >100)
     */
